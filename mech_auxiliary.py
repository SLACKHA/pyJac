...
def write_mechanism_initializers(path, lang, specs, reacs):
    ...
    with open(path + 'mechanism.c', 'w') as file:
        ...
        file.write('    void write_rates(FILE* fp, const double* fwd_rates, const double* rev_rates, const double* pres_mod, const double* sp_rates, const double* dy) {\n'
        ...
        file.write('    void write_jacobian_and_rates_output() {\n'
                   ...
                   '        write_rates(fp, fwd_rates, rev_rates, pres_mod, sp_rates, dy);\n'
