...
def plotsm(lang, norm=True):
    ...
    miny = plot(plotdata1, nco_marker, 'Shared Memory Caching', miny, norm=thenorm)
    miny = plot(plotdata2, co_marker, 'No Shared Memory Caching', miny, norm=thenorm)
