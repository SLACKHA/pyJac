...
if __name__ == '__main__':
    parser = ArgumentParser(
        description='Tests pyJac versus a finite difference Cantera jacobian\n'
    )
    parser.add_argument(
        '-l',
        '--lang',
    ...
    parser.add_argument(
        ...
        dest='generate_jacob',
        default=True,
        help='Use this option to have the tester use existing Jacobian files',
    )
    parser.add_argument(
        '-s',
        '--seed',
    ...
    parser.add_argument(
        ...
        dest='compile_jacob',
        default=True,
        help='Use this option to force the tester to use previously compiled files',
    )
    parser.add_argument(
        '-orxn',
        '--only_reaction',
    ...
    parser.add_argument(
        ...
        default=None,
        type=str,
        help='Comma separated list of conditions to test, useful for debugging.',
    )
    args = parser.parse_args()
    test.test(
        args.lang,
        str(Path(test.__file__).resolve().parent),
        args.build_dir,
        args.mech,
        args.thermo,
        args.input,
        ...
        args.pasr_output,
        args.last_spec,
        args.cache_optimization,
        args.no_shared,
        args.tchem,
        args.only_reaction,
        args.do_not_remove,
        args.condition_numbers,
    )
