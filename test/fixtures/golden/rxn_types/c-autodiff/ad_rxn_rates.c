...
void eval_rxn_rates (const adouble T, const adouble& pres, const adouble * __restrict__ C, adouble * __restrict__ fwd_rxn_rates, adouble * __restrict__ rev_rxn_rates) {
  ...
  //rxn 1
  fwd_rxn_rates[1] = C[2] * C[0] * exp(3.8262472284067424e+00 + 2.7 * logT - (3.1501542797022739e+03 / T));
  //rxn 2
  fwd_rxn_rates[2] = C[0] * C[4] * exp(1.2063356343328579e+01 + 1.51 * logT - (1.7260429999007667e+03 / T));
  //rxn 3
  fwd_rxn_rates[3] = C[5] * C[1] * exp(1.1723186390453424e+01 + 1.4 * logT - (9.0579516029777842e+03 / T));
  //rxn 4
