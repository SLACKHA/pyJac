...
__device__ void eval_rxn_rates (const double T, const double pres, const double * __restrict__ C, double * __restrict__ fwd_rxn_rates, double * __restrict__ rev_rxn_rates, double * __restrict__ dot_prod) {
  ...
  fwd_rxn_rates[INDEX(0)] = C[INDEX(1)] * C[INDEX(3)] * kf;
  if (T <= 1000.0) {
  ...
  rev_rxn_rates[INDEX(0)] = C[INDEX(2)] * C[INDEX(4)] * kf / Kc;

  //rxn 1
  fwd_rxn_rates[INDEX(1)] = C[INDEX(2)] * C[INDEX(0)] * exp(3.8262472284067424e+00 + 2.7 * logT - (3.1501544760183588e+03 / T));
  //rxn 2
  fwd_rxn_rates[INDEX(2)] = C[INDEX(0)] * C[INDEX(4)] * exp(1.2063356343328579e+01 + 1.51 * logT - (1.7260431074669282e+03 / T));
  //rxn 3
  fwd_rxn_rates[INDEX(3)] = C[INDEX(5)] * C[INDEX(1)] * exp(1.1723186390453424e+01 + 1.4 * logT - (9.0579521674649295e+03 / T));
  //rxn 4
  kf = exp(2.9181557920442486e+01 - 1.0 * logT);
  fwd_rxn_rates[INDEX(4)] = C[INDEX(1)] * C[INDEX(2)] * kf;
  if (T <= 1000.0) {
  ...
  rev_rxn_rates[INDEX(1)] = C[INDEX(4)] * kf / Kc;

  //rxn 5
  kf = exp(2.2355638720663009e+01 + 0.44 * logT);
  fwd_rxn_rates[INDEX(5)] = C[INDEX(1)] * C[INDEX(3)] * kf;
  if (T <= 1000.0) {
  ...
  rev_rxn_rates[INDEX(3)] = C[INDEX(4)] * C[INDEX(4)] * kf / Kc;
  ...
  fwd_rxn_rates[INDEX(7)] = C[INDEX(6)] * C[INDEX(1)] * kf;
  if (T <= 1000.0) {
  ...
  Kc = 1.0000000000000000e+00 * exp(Kc);
  rev_rxn_rates[INDEX(4)] = C[INDEX(4)] * C[INDEX(4)] * kf / Kc;
  ...
  kf = exp10(kf);
  fwd_rxn_rates[INDEX(8)] = C[INDEX(6)] * C[INDEX(4)] * kf;
  if (T <= 1000.0) {
  ...
  Kc = 1.0000000000000000e+00 * exp(Kc);
  rev_rxn_rates[INDEX(5)] = C[INDEX(5)] * C[INDEX(3)] * kf / Kc;

  //rxn 9
  kf = exp(1.8683045008419857e+01 - (-8.2024789072043529e+02 / T));
  fwd_rxn_rates[INDEX(9)] = C[INDEX(6)] * C[INDEX(6)] * kf;
  if (T <= 1000.0) {
  ...
  Kc = 1.0000000000000000e+00 * exp(Kc);
  rev_rxn_rates[INDEX(6)] = C[INDEX(7)] * C[INDEX(3)] * kf / Kc;

  //rxn 10
  kf = exp(2.6763520548223823e+01 - (6.0386347783099527e+03 / T));
  fwd_rxn_rates[INDEX(10)] = C[INDEX(6)] * C[INDEX(6)] * kf;
  if (T <= 1000.0) {
    Kc = (2.0442853999999988e-01 + -5.4502697000000033e-01 * logT + T * (2.9793422214999996e-03 + T * (-2.6226176816666659e-06 + T * (1.4412002008333336e-09 + -3.3581152400000006e-13 * T))) - -1.9356141739999999e+04 / T);
  } else {
    Kc = (1.3860647200000007e+00 + -5.8688111000000109e-01 * logT + T * (9.5588210999999991e-04 + T * (-2.3200710316666662e-07 + T * (2.9346983416666660e-11 + -1.4440451450000000e-15 * T))) - -1.9173958845999998e+04 / T);
  ...
  Kc = 1.0000000000000000e+00 * exp(Kc);
  rev_rxn_rates[INDEX(7)] = C[INDEX(7)] * C[INDEX(3)] * kf / Kc;
