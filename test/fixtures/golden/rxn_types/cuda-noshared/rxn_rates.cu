...
__device__ void eval_rxn_rates (const double T, const double pres, const double * __restrict__ C, double * __restrict__ fwd_rxn_rates, double * __restrict__ rev_rxn_rates, double * __restrict__ dot_prod) {
  ...
  //rxn 1
  fwd_rxn_rates[INDEX(1)] = C[INDEX(2)] * C[INDEX(0)] * exp(3.8262472284067424e+00 + 2.7 * logT - (3.1501542797022739e+03 / T));
  //rxn 2
  fwd_rxn_rates[INDEX(2)] = C[INDEX(0)] * C[INDEX(4)] * exp(1.2063356343328579e+01 + 1.51 * logT - (1.7260429999007667e+03 / T));
  //rxn 3
  fwd_rxn_rates[INDEX(3)] = C[INDEX(5)] * C[INDEX(1)] * exp(1.1723186390453424e+01 + 1.4 * logT - (9.0579516029777842e+03 / T));
  //rxn 4
